<?php /* Template Name: COLORS OF PEACE AW 25.26 */ ?>
<?php get_header() ?>
<?php global $post; ?> 
<?php $ppid = 7239;?>
<?php
$imgsrc='https://rswm.in/wp-content/uploads/2024/07/template-colors-of-peace.jpg'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
