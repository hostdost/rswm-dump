<?php /* Template Name: collection New11 */ ?>
	...
	<div class="row">
		<div class="col span_12">
			<div class="new-collection-heading">
				<img src="<?php echo get_template_directory_uri() ?>/images/rswm_collage.jpg" />
				<h1 class="hider">COLLECTIONS</h1>
			</div>
		</div>
	</div>
	<div class="container">
					...
					<div class="col-md-6 col-12 span_6">
						<div class="new-collection-thumb-image">
							<a href="<?php echo get_permalink(7545) ?>"
								...
								title="SPRING SUMMER COLLECTION 2026">
								<img
							...
							<h4>
								<a href="<?php echo get_permalink(7545) ?>"
									class="<?php echo $obj->ID == 7545 ? 'active' : '' ?>"
									title="SPRING SUMMER COLLECTION 2026">INTELLIGENT SIMPLICITY</a>
