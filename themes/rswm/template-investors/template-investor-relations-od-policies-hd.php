...
/* Template Name: Investors Relations OD 30 Policies HD*/
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse"
                                                    ...
                                                    Policies<span> <i class="ion-plus"></i>
                                                ...
                                                <div class="Accordian_content" style="display: block;">
                                                    ...
                                                    <div class="accordian_Innercontent newspaper-accord-wrap">
                                                        <ul class="service-details-list">
                                                            ...
                                                            <li><a href="https://rswm.in/pdf/od/Corporate_Social_Responsibility_Policy.pdf"
                                                                    target="_blank">
                                                                    Corporate Social
                                                                    Responsibility Policy </a></li>
                                                            <li><a href="https://rswm.in/pdf/od/Preservation_of_Documents.pdf"
                                                                    target="_blank">
                                                                    Preservation of
                                                                    Documents</a></li>
                                                            <li><a href="https://rswm.in/pdf/od/Sexual_Harrasment_Policy.pdf"
                                                                    target="_blank">
                                                                    Sexual Harassment
                                                                    Policy</a></li>
                                                            <li><a href="https://rswm.in/pdf/od/RSWM_Economic_Environment_and_Social_Policy.PDF"
                                                                    target="_blank">
                                                                    Economic Enviornment
                                                                    and Social Policy</a></li>
                                                            <li><a href="https://rswm.in/pdf/od/Board_Performance_Evaluation_Policy.pdf"
                                                                    target="_blank">
                                                                    Board Performance
                                                                    Evaluation Policy</a></li>
                                                            <li><a href="https://rswm.in/pdf/od/Archival_Policy.pdf"
                                                                    target="_blank"> Policy of Archival</a></li>
