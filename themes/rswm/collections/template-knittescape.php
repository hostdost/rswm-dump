<?php /* Template Name: Knittscape 24.25 */ ?>
<?php get_header() ?>
<?php global $post; ?> 
<?php $ppid = 7091;?>
<?php
...
$imgsrc='https://rswm.in/wp-content/uploads/2024/02/knitscape-header.png'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
