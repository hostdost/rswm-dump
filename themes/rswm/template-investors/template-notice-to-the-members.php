<?php 
/* 
 * Template Name: Notice to the Members
*/ 
get_header();
global $post;
?>
			...
			<section class="program-description">
				<div class="row">
					<div class="col span_12">
						...
						<div class="date-description">
							<ul>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/notice-to-the-members/RSWM-AGM-Notice-2017.pdf" target="_blank">RSWM AGM Notice 2017</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/notice-to-the-members/RSWM-AGM-Notice-2016.pdf" target="_blank"> RSWM AGM Notice 2016</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/notice-to-the-members/RSWM-AGM-Notice-2015.pdf" target="_blank"> RSWM AGM Notice 2015</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/notice-to-the-members/RSWM-AGM-Notice-2014.pdf" target="_blank"> RSWM AGM Notice 2014</a></li>
							</ul>
						</div>
					</div>
				</div>
