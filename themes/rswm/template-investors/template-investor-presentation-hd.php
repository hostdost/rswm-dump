<?php
/* Template Name: Investors Presentation HD */
get_header('hd');
                    ...
                    <div class="service-details-page-content">
                        ...
                        <div class="service-details-text-wrapper section-space--bottom--50">
                            ...
                            <div class="faq-wrapper">
                                ...
                                <?php $Compliances_terms = get_term_by('id', 89, $default_taxnomy); ?>
                                <div id="accordion">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse"
                                                    ...
                                                    <?php echo $Compliances_terms->name ?><span> <i
                                                            class="ion-plus"></i>
                                                            ...
                                                            <div class="investor-select-wrap">
                                                                ...
                                                                <div class="investor-select-box">
                                                                    <input type="hidden" name="class"
                                                                        value="compliances_responsive_dup">
                                                                    <input type="hidden" name="main_term_id"
                                                                        value="<?php echo $Compliances_terms->term_id ?>">
