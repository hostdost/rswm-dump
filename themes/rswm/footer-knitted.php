<footer>
    <div class="stickyButtontwo" style="display: none!important;">
        <a href="<?php echo site_url(); ?>/wp-content/uploads/2021/09/RSWM_We-Care.pdf" target="blank" style=""> From
                                ...
                                <form action="" method="post" id="subscribe-details" class="fome"
                                    ...
                                    <div class="subscribe-input-box">
                                        <input type="text" autocapitalize="off" autocorrect="off" spellcheck="false"
                                            name="fname" placeholder="First Name" id="first-name" title="First Name"
                                    ...
                                    <div class="subscribe-actions">
                                        <button type="submit" title="Sign up" name="signup" class="button"
                                            id="newsletter-subscribehome"><span><span>SIGN UP</span></span></button>
...
<script>
    jQuery(document).ready(function() {
        ...
        jQuery(document).on('click',
            ' .melangColorBoxLeft.book_section .dropdown .dropdown-menu li',
            function() {
