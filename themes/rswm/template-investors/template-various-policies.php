<?php 
/* 
 * Template Name: Various Policies
*/ 
get_header();
global $post;
?>
				...
				<div class="row">
					<div class="col span_12">
						<div class="program-heading">
							<h2>Various Policies</h2>
						</div>
						<div class="date-description">
							<!--h4>Various Policies Details</h4-->
							<ul>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/various-policies/Related_Party_Transaction_Policy-2018.pdf" target="_blank"> Related Party Transaction Policy-2018</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/various-policies/RSWM-Whistle-Blower-Policy-2018.pdf" target="_blank"> Whistle Blower Policy-2018</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/various-policies/Nomination-&-Remuneration-Policy.pdf" target="_blank">Nomination & Remuneration Policy</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/various-policies/Determination Materiality-o- Events_RSWM.pdf" target="_blank"> Determination Materiality of Events</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/various-policies/Material_Subsidiary_RSWM.pdf" target="_blank"> Material Subsidary</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/various-policies/Policy-of-Archival_RSWM.pdf" target="_blank"> Policy of Archival</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/various-policies/RSWM_CSR_POLICY.pdf" target="_blank"> CSR POLICY</a></li>
							</ul>
						</div>
					</div>
				</div>
