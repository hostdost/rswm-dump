<footer>
    ...
    <div class="stickyButtontwo" style="display: none!important;">
        <a href="<?php echo site_url(); ?>/wp-content/uploads/2020/04/RSWM_Cares_covid19.pdf" target="blank" style="">
            RSWM's Response to <span class="covid"> COVID-19 </span></a>
    </div>
    <div class="stickyButtonthree" style="display: none!important;">
        <a href="<?php echo site_url(); ?>/wp-content/themes/rswm/images/pdf/RSWM_SOP_Back_to_Work.pdf" target="blank"
            style=""> Back to work <span class="covid"> after COVID-19</span></a>
    </div>
    <div class="container">
        <div class="row">
            <div class="col span_12">
                <ul class="footer_menu">
                    ...
                    <li><a href="https://news.rswm.in/" target="_blank" class=""
    ...
    jQuery(document).ready(function() {
        ...
        jQuery(document).on('click',
            ...
            function() {
                ...
                var blend_name = jQuery("#blend_name").val();
                var end_usage_name = jQuery("#end_usage_name").val();
                ...
                if (jQuery('.melangColorBoxLeft.book_section input').val() != '') {
                    ...
                    checkboxValues_book.push(jQuery('.melangColorBoxLeft.book_section input').val());
                }
                ...
                jQuery.post("<?php echo admin_url('admin-ajax.php') ?>", {
                    ...
                    'book_id': book_id,
                    'colorcode': colorcode,
                    'action': 'category_filter_post_melange_test'
                }, function(res) {
                    if (res.status == 1) {
