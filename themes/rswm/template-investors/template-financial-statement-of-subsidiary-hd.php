<?php
/* Template Name: Financial Statement of Subsidiary*/
                ...
                <div class="col-lg-8 order-1 order-lg-2">
                    <div class="service-details-page-content">
                        <div class="service-details-image-block section-space--bottom--50 d-none">
                            <div class="image">
                                <img src="<?php echo site_url('/'); ?>assets/img/banners/financial-statement-banner.jpg" class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="service-details-text-wrapper section-space--bottom--50">
                            ...
                            <div class="faq-wrapper">
                                <?php $Compliances_terms = get_term_by('id', 439, $default_taxnomy, array()); ?>
                                <div id="accordion">
                                    <div class="card">
