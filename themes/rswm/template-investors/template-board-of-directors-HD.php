<?php
/* Template Name: Board of directors-HD.php */
                    ...
                    <div class="service-details-page-content">
                        ...
                        <div class="service-details-text-wrapper section-space--bottom--50">
                            ...
                            <div class="faq-wrapper">
                                <?php //$terms = get_term_by('id', 118, $default_taxnomy); 
                                ?>
                                <div id="accordion">
                                    <div class="card">
                                                ...
                                                <div class="Accordian_content" style="display: block;">
                                                    <div class="accordian_Innercontent">
                                                        <ul class="compliances_responsive director-table">
                                                            <li>
                                                                ...
                                                                <table border="1">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>1</td>
                                                                            <td>Smt Archana Capoor</td>
                                                                            <td>Chairman</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>2</td>
                                                                            <td>Shri Suman Jyoti Khaitan</td>
                                                                            <td>Member</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>3</td>
                                                                            <td>Shri Thomas Varghese</td>
                                                                            <td>Member</td>
                                                                        </tr>
                                                            ...
                                                            <li>
                                                                <h4>
                                                                    Stakeholders’ Relationship Committee </h4>
                                                                <table border="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>Sl. No.</th>
                                                                        ...
                                                                        <tr>
                                                                            <td>4</td>
                                                                            <td>Shri Sunil Dharamvir Dhawan</td>
                                                                            <td>Member</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            ...
                                                            <li>
                                                                <h4>
                                                                    Nomination And Remuneration Committee </h4>
                                                                <table border="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>Sl. No.</th>
                                                            ...
                                                            <li>
                                                                <h4>
                                                                    Corporate Social Responsibility Committee </h4>
                                                                <table border="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>Sl. No.</th>
