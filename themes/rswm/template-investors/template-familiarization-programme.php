<?php 
/* 
 * Template Name: Familiarization Programme
*/ 
get_header();
global $post;
?>
				...
				<div class="row">
					<div class="col span_12">
						...
						<div class="date-description">
							<h4>2017-18</h4>
							<ul>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/Familiarization-programme/RSWM_Familiarization_Policy_2017-18.pdf" target="_blank"> Familiarization Programmes for Independent Directors</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/Familiarization-programme/Details_of_Familirization_Programme_Archana_Capoor.pdf" target="_blank"> Details of the Familiarization Programme imparted to Independent Director.</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/Familiarization-programme/Details_of_Familiarization_Programme_2017-18.pdf" target="_blank"> Details of the Familiarization Programme imparted to Independent Directors.</a></li>
							</ul>
						</div>
						<div class="date-description">
							<h4>2016-17</h4>
							<ul>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/Familiarization-programme/Familiarisation_Programmes_for_Independent_Directors.pdf" target="_blank"> Familiarization Programmes for Independent Directors</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/Familiarization-programme/Details_of_Familirization_Programme_2016-17.pdf" target="_blank"> Details of the Familiarization Programme imparted to Independent Directors.</a></li>
							</ul>
						</div>
				</div>
			</section> 
