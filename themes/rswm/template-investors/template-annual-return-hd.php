<?php
/* Template Name: Annual Return hd */
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse"
                                                    ...
                                                    <?php //echo $terms->name 
                                                    ?> Annual Return<span> <i class="ion-plus"></i>
                                                ...
                                                <div class="Accordian_content" style="display: block;">
                                                    <div class="accordian_Innercontent">
                                                        ...
                                                        <ul class="compliances_responsive">
                                                            <li><a href="https://rswm.in/wp-content/uploads/2025/12/Annual-Return-2024-25.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2024-25" ?>
                                                                </a>
                                                            </li>
                                                            <li><a href="https://rswm.in/wp-content/uploads/2024/07/Annual-Return-2023-24.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2023-24" ?>
                                                                </a>
                                                            </li>
                                                            <li><a href="https://rswm.in/wp-content/uploads/2023/08/Annual-Return-2022-23.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2022-23" ?>
                                                                </a>
                                                            </li>

                                                            <li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/annual-report/ANNUAL-RETURN-2021-22.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                            ...
                                                            <li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/annual-report/annual-return-2020-21.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                            ...
                                                            <li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/annual-report/Annual-Return-2019-20.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                            ...
                                                            <li><a href="https://rswm.in/wp-content/uploads/2022/12/Annual-Return-2018-19.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2018-19" ?>
                                                                </a>
                                                            </li>
                                                            <li><a href="https://rswm.in/wp-content/uploads/2022/12/Annual-Return-2017-18.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2017-18" ?>
                                                                </a>
                                                            </li>
                                                            <li><a href="https://rswm.in/wp-content/uploads/2022/12/Annual-Return-2016-17.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2016-17" ?>
                                                                </a>
                                                            </li>
                                                            <li><a href="https://rswm.in/wp-content/uploads/2022/12/Annual-Return-2015-16.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2015-16" ?>
                                                                </a>
                                                            </li>
                                                            <li><a href="https://rswm.in/wp-content/uploads/2022/12/Annual-Return-2014-15.pdf"
                                                                    target="_blank">
                                                                    <img src="<?php echo get_template_directory_uri() ?>/images/pdf-icon.png"
                                                                        alt="" />
                                                                    <?php echo "Annual Return 2014-15" ?>
                                                                </a>
                                                            </li>
