<?php 
/* 
 * Template Name: Unpaid & Unclaimed Dividend Amount
*/ 
get_header();
get_header();
global $post;
				...
				<div class="row">
					<div class="col span_12">
						<div class="program-heading">
							<h2>Unpaid & Unclaimed Dividend Amount</h2>
						</div>
						
						<div class="date-description">
							<ul>
								<li> Unpaid & Unclaimed Dividend 2009-10<a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-Unclaimed/Unpaid_and_Unclaimed_Dividend_2009-10.pdf" target="_blank"> Click Here</a></li>
								<li> Unpaid & Unclaimed Interim Dividend 2010-11<a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-Unclaimed/Unpaid_and_Unclaimed_Interim_Dividend_2010-11.pdf" target="_blank"> Click Here</a></li>
								<li> Unpaid & Unclaimed Final Dividend 2010-11<a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-Unclaimed/Unpaid_and_Unclaimed_Final_Dividend_2010-11.pdf" target="_blank"> Click Here</a></li>
								<li> Unpaid & Unclaimed Dividend 2012-13<a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-Unclaimed/Unpaid_and_Unclaimed_Dividend_2012-13.pdf" target="_blank"> Click Here</a></li>
								<li> Unpaid & Unclaimed Dividend 2013-14<a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-Unclaimed/Unpaid_and_Unclaimed_Dividend_2013-14.pdf" target="_blank"> Click Here</a></li>
								<li> Unpaid & Unclaimed Dividend 2014-15<a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-Unclaimed/Unpaid_and_Unclaimed_Dividend_2014-15.pdf" target="_blank"> Click Here</a></li>
								<li> Unpaid & Unclaimed Dividend 2015-16<a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-Unclaimed/Unpaid_and_Unclaimed_Dividend_2015-16.pdf" target="_blank"> Click Here</a></li>
							</ul>
						</div>
					</div>
				</div>
