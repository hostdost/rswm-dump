<?php /* Template Name: MELANTRA AW 26-27 */ ?>
<?php get_header() ?>
<?php global $post; ?>
<?php $ppid = 7807; ?>
<?php
$imgsrc = 'https://rswm.in/wp-content/uploads/2025/09/aw-26-27-fusion-banner-full.png'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
...
<div class="container" style="margin-top: 50px;">
    <iframe allowfullscreen="allowfullscreen" allow="clipboard-write" scrolling="no" class="fp-iframe"
        src="https://heyzine.com/flip-book/dc131f830a.html"
        style="border: 1px solid lightgray; width: 100%; height: 528px;"></iframe>
</div>
<!-- Flipbook -->


<div class="inner-design-pop" id="data-form" style="display:none;">
    <div class="row product_details11" style="min-width:500px;min-height:500px;">
        <div>Please wait..</div>
    </div>
</div>
...
*/
    ...
    .aboutContact_form .forBusibess h3,
    .aboutContact_form .forBusibess h2,
    .aboutContact_form .forBusibess h2 a {
    ...
    $(document).ready(function() {
        ...
        jQuery(document).on('click', ".collection-image", function() {
            jQuery(".product_details11").html(
                '<div style="text-align: center;"><img src="<?php echo get_template_directory_uri() ?>/images/preload.svg" style="width:100px;margin: 23px;"></div>'
            );
            jQuery.fancybox({
                width: '100%',
                height: 'auto',
        ...
        function sameHeight() {
            ...
            if (wWidth >= 770) {
                ...
                $('.reneu-whole-wrap >.productZommer').each(function(e) {
                    var heightformobile = $('.productZommer >.row.MakeItTable > .reneu-content').height() +
                        $('.productZommer >.row.MakeItTable > .reneuimage-wrap ').height();
...
<style>
    ...
    @media only screen and (max-width: 767px) {
        ...
        section.productZommer.section2.mob-padding.odd,
        section.productZommer.section2.mob-padding.even {
            margin-bottom: 32px;
        }
