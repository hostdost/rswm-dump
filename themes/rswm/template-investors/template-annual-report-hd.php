<?php
/* Template Name: Annual Reports hd */
                ...
                <div class="col-lg-8 order-1 order-lg-2">
                    <div class="service-details-page-content">
                        ...
                        <div class="service-details-text-wrapper section-space--bottom--50">
                            ...
                            <!--- -->
                            <div class="faq-wrapper">
                                <?php $bsterms = get_term_by('id', 438, $default_taxnomy); ?>
                                <div id="accordion">
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse"
                                                    ...
                                                    <?php echo $bsterms->name ?> <span> <i class="ion-plus"></i>
                                                        <i class="ion-minus"></i> </span>
                                                </button>
                                            </h5>
                                        </div>
                                                            ...
                                                            <div class="investor-select-wrap">
                                                                ...
                                                                <div class="accordian_Innercontent">
                                                                    <?php $shareholder_args = array(
                                                                        ...
                                                                        "order" => "DESC",
                                                                        "tax_query"  => array(
                                                                            array("taxonomy" => $bsterms->taxonomy, "field" => "id", "terms" => array($bsterms->term_id), 'include_children' => false),
                                                                        ),
                                                                    );
