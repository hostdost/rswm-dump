<?php
/* Template Name: Email address of Grievance Redressal hd */
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse"
                                                    ...
                                                    <?php //echo $terms->name 
                                                    ?>Email address of Grievance Redressal <span> <i
                                                            class="ion-plus"></i>
                                                ...
                                                <div class="Accordian_content" style="display: block;">
                                                    <div class="accordian_Innercontent">
                                                        <ul class="share_holder_responsive">
                                                            <li>
                                                                <a href="mailto:rswm.investor@lnjbhilwara.com"
                                                                    style="text-transform:lowercase;"><i
                                                                        class="fa fa-envelope-o" aria-hidden="true"></i>
                                                                    rswm.investor@lnjbhilwara.com</a>
                                                            </li>
