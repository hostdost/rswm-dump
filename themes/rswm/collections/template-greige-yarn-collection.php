<?php /* Template Name: GREIGE YARN COLLECTION 24 */ ?>
<?php get_header() ?>
<?php global $post; ?> 
<?php $ppid = 7451;?>
<?php
$imgsrc='https://rswm.in/wp-content/uploads/2024/08/template-greige-yarn-collection.png'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
