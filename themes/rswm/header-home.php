...
<head>
    ...
    <title>RSWM Limited- Largest Yarn and Knitted Fabric Manufacturer in India</title>
    <meta name="description"
        content="RSWM Limited is the India's leading Largest Yarn and Knitted Fabric Manufacturer in India with world-class technology for yarn & fabric production.">
    <meta name="keywords" content="RSWM Limited, RSWM, RSWM limited Bhilwara, Bhilwara Group, Best Yarn Fabric Manufacturing Company, Jaspe Viscose Yarn, Blended Yarn, Leading Spinning Mills 
">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, user-scalable=0">
    <meta property="og:image" content="<?php echo get_template_directory_uri(); ?>/images/rswm-logo.svg">
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-P5BX447M');
    </script>
    <!-- Raman Munjal -->
    <!-- Google tag (gtag.js) -->
                ...
                <div class="row">
                    ...
                    <div class="col span_10 col-md-10 col-8">
                        <div class="mobile-navigation">
                            <a href="#menu" id="toggle" class="d-block"
                                style="<?php echo wp_is_mobile() ? 'display: block;' : ''; ?>">
