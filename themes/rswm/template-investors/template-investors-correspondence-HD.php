<?php
/* Template Name: Investors Correspondence-HD */
get_header('hd');
global $post;
                    ...
                    <div class="service-details-page-content">
                        ...
                        <div class="service-details-text-wrapper section-space--bottom--50">
                            ...
                            <div class="faq-wrapper">
                                <?php $terms = get_term_by('id', 114, $default_taxnomy);
                                ?>
                                <div id="accordion">
                                    <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="Accordian_content" style="display: block;">
                                                    <div class="accordian_Innercontent">
                                                        ...
                                                        <ul
                                                            class="share_holder_responsive investors-correspondence-contact">
