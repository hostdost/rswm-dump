<?php 
/* 
 * Template Name: Investors Correspondence
 */ 
get_header();
global $post;
?>
		...
		<div class="container invester-block">
			...
			<section class="program-description">
				<div class="row">
					...
					<h2>Investor Correspondence</h2>
				</div>
				<div class="date-description">
					<h4>Investor correspondence should be addressed to :</h4>
					
					<div class="address_block">
						<p>
							<strong>Registrar & Transfer Agent</strong><br>
							MCS Share Transfer Agent Limited,<br> 
							F-65, Okhla Industrial Area, Phase I,<br>
							New Delhi – 110 020 <br>
							Tel: +91-011-41406149-52, Fax: +91-011-41709881,<br>
							E -mail: <a href="mailto:mcssta@rediffmail.com">mcssta@rediffmail.com</a>, <a href="mailto:helpdeskdelhi@mcsregistrars.com">helpdeskdelhi@mcsregistrars.com</a>, <a href="mailto:admin@mcsdel.com">admin@mcsdel.com</a> 
						</p>
					</div>
					<div class="address_block">
						<p>
							...
							RSWM Limited,<br> 
							Bhilwara Towers, A-12, Sector-1, Noida - 201 301 (U.P) ,<br>
							Tel: +91-0120-2541810, 4390300, Fax: +91-0120-4277841, <br>
							E-mail : <a href="skg@lnjbhilwara.com">skg@lnjbhilwara.com</a>, <a href="rswm.investor@lnjbhilwara.com">rswm.investor@lnjbhilwara.com</a> 
						</p>
					</div>
					<div class="address_block">
						<p>
							<strong>Registered Office</strong><br>
							Kharigram, P.O. Gulabpura – 311 021,<br> 
							Distt. Bhilwara, Rajasthan,<br>
							Tel: +91-1483-223144 to 223150, 223478<br>
							Fax: +91-1483-223361, 223479 
						</p>
					</div>
					<div class="address_block">
						<p>
							<strong>Company Secretary & Compliance Officer</strong><br>
							Mr. Surender Gupta,<br> 
							E-mail : <a href="skg@lnjbhilwara.com">skg@lnjbhilwara.com</a>, <a href="rswm.investor@lnjbhilwara.com">rswm.investor@lnjbhilwara.com</a><br>
							
						</p>
					</div>
					<div class="address_block">
						<p>
							<strong>Grievances Redressal Cell</strong><br>
							Mr. Sanjay Rastogi,<br> 
							E-mail : <a href="skg@lnjbhilwara.com">skg@lnjbhilwara.com</a>, <a href="rswm.investor@lnjbhilwara.com">rswm.investor@lnjbhilwara.com</a>
							Ph.: +91-120-4390187, +91-120-4390058
						</p>
					</div>
			...
			<aside class="aside-right-details"> 
				<img src="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investor-correspondence/invstr_correspnce.gif">
			</aside>
