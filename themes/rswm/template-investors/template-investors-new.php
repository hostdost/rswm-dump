<?php 
	/* Template Name: Investors New Test*/ 
	get_header();
	global $post;
?>
<?php
get_template_part('template-investors/investors','toppart'); 
get_template_part('template-investors/investors','menu'); ?>
				...
				<div class="row">
					<div class="col span_12">
						...
						<div class="date-description">
							<!--<h4>Document</h4>-->
							<ul>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern01-31-03-2018.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st March, 2018</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/RSWM_Shareholding_Pattern_31-12-2017.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st December, 2017</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_pattern_rswm30-09-2017.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th September, 2017</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/RSWM_Shar_holding_Pattern_30-06-2017.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th June, 2017</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_31-03-2017.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st March, 2017</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_31-12-2016.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st December, 2016</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_30-09-2016.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th September, 2016</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-30-06-2016.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th June, 2016</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_31-03-2016.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st March, 2016</a></li>								
							</ul>
                            
                            <div class="archivetext" style="display: none;">
                            <ul>
								
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_31_12_2015.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st December, 2015</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_30_09_2015.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th September, 2015</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_30-06-2015.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th June, 2015</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/RSWM-Shareholding-Pattern-31-03-2015.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st March, 2015</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-31-12-2014.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st December, 2014</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-30-09-2014.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th September, 2014</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_30-06-2014-2.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th June, 2014</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-31-03-2014.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st Mar, 2014</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-31-12-2013.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st Dec, 2013</a></li>
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-30-09-2013.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th Sep, 2013</a></li>	
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_30_06_2013.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th June, 2013</a></li>	
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_31_03_2013.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st March, 2013</a></li>								
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-31-12-2012.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 31st Dec, 2012</a></li>	
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding-Pattern-30-09-2012.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th Sep, 2012</a></li>	
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Clause-35.pdf" target="_blank"> Shareholding Pattern of the Quarter ended 30th June, 2012</a></li>	
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Shareholding_Pattern_31.03.2012.pdf" target="_blank"> Shareholding Pattern of the Qruarter ended 31st March, 2012</a></li>	
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Clause-35- RSWM.pdf" target="_blank"> Shareholding Pattern of the Qruarter ended 31st Dec, 2011</a></li>	
								<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/Clause-35- RSWM.pdf" target="_blank"> Shareholding Pattern of the Qruarter ended 30th September, 2011</a></li>	
								
							</ul>
                            </div>
                            <div class="view-archive"> <a href="#" class="toggle">Show Archive</a></div>
						</div>
					</div>
				</div>
			</section> 
			<aside class="aside-right-details"> 
				<div class="program-heading"><h2>Compliances Report</h2></div>
				<div class="date-description">
					<!--<h4>Document</h4>-->
					<ul>
						<li><a href="<?php echo get_template_directory_uri() ?>/template-investors/pdf/investors-relations/RSWM-Corporate-Governance-Quarter-31-03-2018.pdf" target="_blank"> Compliances Report for the Quarter ended 31st March, 2018</a></li>
