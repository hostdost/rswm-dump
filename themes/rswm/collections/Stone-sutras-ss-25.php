<?php /* Template Name: Stones Sutra SS-25 */ ?>
<?php get_header() ?>
<?php global $post; ?> 
<?php $ppid = 7131;?>
<?php
...
$gkj_collection_product_other_info_count = get_post_meta($ppid,'gkj_collection_product_other_info_count',false);
$imgsrc='https://rswm.in/wp-content/uploads/2024/02/stones-sutras-header_banner.jpg'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
