<?php
/* Template Name: Newspaper Advertisement Financial Results */
                    ...
                    <div class="service-details-page-content">
                        ...
                        <div class="service-details-text-wrapper section-space--bottom--50">
                            ...
                            <div class="faq-wrapper">
                                <?php $taxnomyresult = get_term_by('id', 117, $default_taxnomy);
                                ?>
                                <div id="accordion">
                                    <div class="card">
                                                ...
                                                <div class="Accordian_content" style="display: block;">
                                                    <div class="accordian_Innercontent">
                                                        <div class="investor-select-wrap">
                                                            <!-- <h3><?php //echo $taxnomyresult->name 
                                                                        ?></h3> -->
                                                            <div class="investor-select-box">
                                                                <input type="hidden" name="class"
                                                                    value="<?php echo $taxnomyresult->slug ?>_responsive">
                                                                <input type="hidden" name="main_term_id"
                                                                    value="<?php echo $taxnomyresult->term_id ?>">
                                                            ...
                                                            <div class="accordian_Innercontent newfinance">
                                                                ...
                                                                $shareholder_args = array(
                                                                    "post_type" => "investor", 'fields' => 'ids', "post_status" => "publish", "posts_per_page" => -1, "orderby" => 'menu_order', "order" => "DESC",
                                                                    "tax_query"  => array(
                                                                ...
                                                                <ul
                                                                    class="<?php echo $taxnomyresult->slug ?>_responsive">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <a href="<?php echo $wpcfpdfurl != '' ? $wpcfpdfurl : 'javascript:void(0)'; ?>"
                                                                            target="_blank">
                                                                        ...
                                                                        <?php } else { ?>
                                                                        <span class="newspaper-text"> <i
                                                                                class="fa fa-file-pdf-o"
                                                                                aria-hidden="true"></i><?php the_title(); ?>
                                                                        </span>
                                                                        <span class="newspaper-vers"><a
                                                                                href="<?php echo $wpcfpdfurl != '' ? $wpcfpdfurl : 'javascript:void(0)'; ?>"
                                                                                target="_blank">English </a>
                                                                            <span>|</span><a
                                                                                href="<?php echo $wpcfpdfurl2 != '' ? $wpcfpdfurl2 : 'javascript:void(0)'; ?>"
