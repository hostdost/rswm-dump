<?php
/* Template Name: Newspaper Advertisement Shareholders Meeting */
get_header('hd');
global $post;
                    ...
                    <div class="service-details-page-content">
                        ...
                        <div class="service-details-text-wrapper section-space--bottom--50">
                            ...
                            <div class="faq-wrapper">
                                <?php $Compliances_terms = get_term_by('id', 105, $default_taxnomy); ?>
                                ...
                                <div id="accordion">
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    <?php echo the_title(); ?><span> <i class="ion-plus"></i>
                                                                ...
                                                                <div class="investor-select-box">
                                                                    ...
                                                                    <select name="year" class="select_year">
                                                                        <?php foreach ($year_tax as $year) { ?>
                                                                            <option value="<?php echo $year->slug; ?>" <?php echo $year->slug == date("Y") ? 'selected' : '' ?>>
                                                                    ...
                                                                    <ul class="compliances_responsive_dup">
                                                                        <?php if ($Compliances_query->have_posts()) { ?>
                                                                            <?php while ($Compliances_query->have_posts()) {
                                                                                ...
                                                                                <!-- <li><a href="<?php //echo $wpcfpdfurl2 != '' ? $wpcfpdfurl2 : 'javascript:void(0)'; 
                                                                                                    ?>" target="_blank">
                                                                                ...
                                                                                <li>
                                                                                    ...
                                                                                    <span class="newspaper-vers"><a href="<?php echo $wpcfpdfurl1; ?>" target="_blank">English </a> <span>|</span>
                                                                                        <a href="<?php echo $wpcfpdfurl2; ?>" target="_blank">Hindi </a></span>
                                                                                </li>
                                    ...
                                    <?php $terms = get_term_by('id', 111, $default_taxnomy);
                                    ?>
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseFour">
                                                    <?php echo $terms->name ?> <span> <i class="ion-plus"></i>
                                                        <i class="ion-minus"></i> </span>
                                                </button>
                                            </h5>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                        ...
                                                        <ul class="share_holder_responsive">
                                                            <?php if ($shareholder_query->have_posts()) { ?>
                                                                <?php while ($shareholder_query->have_posts()) {
                                                                    ...
                                                                    <li><a href="<?php echo $wpcfpdfurl; ?>" target="_blank">
                                                                            <i class="fa fa-file-pdf-o" aria-hidden="true"></i><?php echo get_the_title() ?></a>
                                                                    </li>
                                                ...
                                                <!-- <div class="accordian_Innercontent newspaper-accord-wrap">
                                                    <ul class="compliances_responsive">
                                                        <li> <span class="newspaper-text"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Tranfer of Shares to IEPF
                                                                Dividend 2013-14 </span><span class="newspaper-vers"><a href="https://www.rswm.in/wp-content/uploads/2022/07/RSWMNewspaperCuttingTrnsfrOFShares08072021.pdf" target="_blank">English </a> </span></li>
                                                        <li> <span class="newspaper-text"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Transfer of Shares to IEPF
                                                                21st July 2022 </span><span class="newspaper-vers"><a href="https://www.rswm.in/wp-content/uploads/2022/07/RSWMNewspaperCuttingTransferOfShares21-07-2022.pdf" target="_blank">English </a> </span></li>
                                                        <li> <span class="newspaper-text"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Notice for Shareholders
                                                                Advertisement 14th June, 2017 </span><span class="newspaper-vers"><a href="https://www.rswm.in/wp-content/uploads/2018/07/20170616172609.pdf" target="_blank">English </a> </span></li>
                                                    </ul>
                                                </div> -->
                                            </div>
                                        </div>
