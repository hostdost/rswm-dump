<?php /* Template Name: KNITS VOYAGE */ ?>
<?php get_header() ?>
<?php global $post; ?>
<?php $ppid = 7451; ?>
<?php
$imgsrc = 'https://rswm.in/wp-content/uploads/2025/09/knits-voyage-banner.jpg'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
...
<div class="container" style="margin-top: 50px;">
    <iframe allowfullscreen="allowfullscreen" allow="clipboard-write" scrolling="no" class="fp-iframe"
        ...
        style="border: 1px solid lightgray; width: 100%; height: 520px;"></iframe>
</div>
<!-- Flipbook -->
