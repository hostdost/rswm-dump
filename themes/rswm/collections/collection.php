<?php /* Template Name: collection New */ ?>
<?php get_header() ?>
<?php global $post; ?>
<?php $ppid = $post->ID;?>
<?php
...
?>
	...
	<!-- The Stones and sutra -->
<div class="col span_6">
	  <div class="new-collection-thumb-image">
	<a href="https://rswm.in/collections/stones-and-sutras/" class="" title="STONES & SUTRAS">
	<img src="https://rswm.in/wp-content/uploads/2023/07/collection-harmonize-min.jpg">
	</a>
	  <h4>
	      <a href="https://rswm.in/collections/stones-and-sutras/" class="" title="STONES & SUTRAS">STONES & SUTRAS</a>
	  </h4>
	</div>
</div>
   <!--/ The Stones and sutra  -->
	...
	<div class="col span_6">
	  <div class="new-collection-thumb-image">
	<a href="https://rswm.in/collections/knitscape/" class="" title="KNITSCAPE">
	<img src="https://www.rswm.in/wp-content/uploads/2022/07/collections-botonica-min.png">
	</a>
	  <h4>
	      <a href="https://rswm.in/collections/knitscape/" class="" title="KNITSCAPE">KNITSCAPE </a>
	  </h4>
	</div>
</div>
   <!--/ Knitscape  -->   
...
<section class="aboutContact_form collection-range-about" id="about_scroll_form">
            ...
            jQuery(document).on('click', ".collection-image", function() {
               ...
               jQuery(document).find('.zoomContainer').remove();
                ...
                jQuery.post("<?php echo admin_url('admin-ajax.php') ?>", {
                    'indexid': pid,
                    'action': 'collection_product_details_popup'
                }, function(resp) {
