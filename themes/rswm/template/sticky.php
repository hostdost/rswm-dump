<?php /* Template Name: Stickyssds Section */?>
...
<div class="testimonials-block" id="jamp">
    <div class="container">
        <div class="lnjBhilwaraContent">
            <h3><a href="<?php echo site_url() ?>/wp-content/uploads/2020/04/RSWM_sustainability.pdf" target="_blank" >Sustainability Policy</a></h3>
        </div>
