...
/* Template Name: Investors Relations Profile & Positions of  Board of Directors HD*/
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse"
                                                    ...
                                                    Brief Profile of Board of Directors including Directorship and Full-time Positions in Body Corporates<span> <i class="ion-plus"></i>
                                                ...
                                                <div class="Accordian_content" style="display: block;">
                                                    ...
                                                    <div class="accordian_Innercontent newspaper-accord-wrap">
                                                        <ul class="service-details-list">
                                                            ...
                                                            <li><a href="/pdf/reg46/Brief_Profile_of_Board_of_Directors.pdf"
                                                                    target="_blank">Brief Profile of Board of Directors</a></li>

                                                            <li><a href="/pdf/reg46/Directorship_and_full-time_Position_in_Body_Corporates.pdf"
                                                                    target="_blank">Directorship and Full-time Positions in Body Corporates</a>
                                                            </li>
