<?php /* Template Name: KNIT FITS SS 26 */ ?>
<?php get_header() ?>
<?php global $post; ?>
<?php $ppid = 7652; ?>
<?php
$imgsrc = 'https://rswm.in/wp-content/uploads/2025/03/knits-fits-banner.png'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
...
<div class="container">
    ...
    <iframe allowfullscreen="allowfullscreen" scrolling="no" class="fp-iframe"
        src="https://heyzine.com/flip-book/9db7a356b1.html"
