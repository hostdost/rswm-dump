...
<div class="main-event-page">
    ...
    <div class="container">
                ...
                ?>
                        <?php if ($count % 2 == 0) { ?>
                            ...
                            <div class="col span_6" style="margin-bottom: 20px;">
                                <div class="left-section" style="min-height: 178px;">
        ...
        <div class="event-section">
        <h3><a href="<?php echo get_permalink(1066) ?>" style="text-decoration:underline;color:#333;" >PAST Exhibitions</a> <!-- | <a href="<?php //echo get_permalink(1066) ?>"  style="text-decoration:none;color:#333;" class="active" >Up Coming Events</a> --> </h3>
<style>
    /* .inner-section{
        vertical-align:top;
    } */
            ...
            ?>
                ...
                <div class="row past-events">
                    ...
                    <?php if ($count % 2 == 0) { ?>
                        ...
                        <div class="col span_6">
                            <div class="left-section" style="padding-top: 20px;">
                                <div class="inner-section" style="vertical-align:top;">
                                    <?php if (get_post_meta($event->ID, 'wpcf-type',  true) == 2) { ?>
                                        <div class="pre-vision"><img src="<?php echo get_post_meta($event->ID, 'wpcf-image',  true) ?>" alt="" /></div>
                                    <?php } ?>
                                    <?php if (get_post_meta($event->ID, 'wpcf-type',  true) == 1) { ?>
