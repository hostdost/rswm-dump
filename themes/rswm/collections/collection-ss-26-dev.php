<?php /* Template Name: Collection SS 26 */ ?>
<?php get_header() ?>
<?php global $post; ?> 
<?php $ppid = 7545;?>
<?php
$imgsrc='https://rswm.in/wp-content/uploads/2025/01/template-ss-26-collection.png'; //                    = wp_get_attachment_image_url( get_post_thumbnail_id($ppid), 'full' );
?>
...
<!-- Flipbook -->
<div class="container">
            <!-- <iframe allowfullscreen="allowfullscreen" scrolling="no" class="fp-iframe" src="https://heyzine.com/flip-book/a807eea2fb.html" style="border: 1px solid lightgray; width: 100%; height: 428px;"></iframe> -->
                <iframe allowfullscreen="allowfullscreen" scrolling="no" class="fp-iframe" src="https://heyzine.com/flip-book/98ee7e1c4e.html" style="border: 1px solid lightgray; width: 100%; height: 400px;"></iframe>
            </div>
            <!-- Flipbook -->
