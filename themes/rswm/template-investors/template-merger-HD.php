                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-uppercase" data-toggle="collapse"
                                                    ...
                                                    <?php echo $mearge_terms->name ?><span> <i class="ion-plus"></i>
                                                            ...
                                                            <div class="investor-select-wrap">
                                                                ...
                                                                <div class="accordian_Innercontent">
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        ?>
                                                                    <p class="merge-term-title"
                                                                        id="<?php echo $mearge_child_terms->slug ?>">
                                                                        <?php echo $mearge_child_terms->name ?></p>
                                                                    <ul class="mearge-li-section">

                                                                        <?php while ($mearge_child_query->have_posts()) {
                                                                                    $mearge_child_query->the_post() ?>
