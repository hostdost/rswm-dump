<?php /* Template Name: collection Melantra */ ?>
...
<div class="new-collection">
    ...
    <div class="row">
        <div class="col span_12">
            <div class="new-collection-heading">
                <img src="<?php echo get_template_directory_uri() ?>/images/collection/melange_banner.jpg" />
                <br>
                <h1 class="hider">MELANTRA COLLECTIONS</h1>
            </div>
        </div>
    </div>
    <!-- Flipbook -->
    <div class="container">
        <iframe allowfullscreen="allowfullscreen" scrolling="no" class="fp-iframe"
            src="https://heyzine.com/flip-book/dc131f830a.html"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 span_6">
                        <div class="new-collection-thumb-image">
                            <a href="<?php echo get_permalink(7807) ?>"
                                class="<?php echo $obj->ID == 7807 ? 'active' : '' ?>" title="AW 26-27">
                                <img src="https://rswm.in/wp-content/uploads/2025/09/aw-26-27-fusion-banner.png" />
                            </a>
                            <h4>
                                <a href="<?php echo get_permalink(7807) ?>"
                                    class="<?php echo $obj->ID == 7807 ? 'active' : '' ?>" title="AW 26-27">AW 26-27</a>
                    ...
                    <div class="col-md-6 col-12 span_6">
                        <div class="new-collection-thumb-image">
                            <a href="<?php echo get_permalink(7545) ?>"
                                class="<?php echo $obj->ID == 7545 ? 'active' : '' ?>" title="INTELLIGENT SIMPLICITY">
                                <img
                                    src="https://assets-rswm.s3.ap-south-1.amazonaws.com/collection/melantra-ss-collection-26.jpg" />
                            </a>
                            <h4>
                                <a href="<?php echo get_permalink(7545) ?>"
                                    class="<?php echo $obj->ID == 7545 ? 'active' : '' ?>"
                                    title="INTELLIGENT SIMPLICITY">INTELLIGENT SIMPLICITY</a>
                                <!-- <a href="<?php //echo get_permalink(7451) 
												?>" class="<?php //echo $obj->ID == 7451 ? 'active' : '' 
                    ...
                    <div class="col-md-6 col-12 span_6">
                        <div class="new-collection-thumb-image">
                            <a href="<?php echo get_permalink(7239) ?>"
                                class="<?php echo $obj->ID == 7239 ? 'active' : '' ?>" title="COLORS OF PEACE AW 25.26">
                                <img src="https://rswm.in/wp-content/uploads/2024/07/collection-colour-of-peace.jpg" />
                            </a>
                            <h4>
                                <a href="<?php echo get_permalink(7239) ?>"
                                    class="<?php echo $obj->ID == 7239 ? 'active' : '' ?>"
                                    title="COLORS OF PEACE AW 25.26">COLORS OF PEACE AW 25.26</a>
                            </h4>
                        </div>
                    </div>
                    <!-- Colour of Peace -->
